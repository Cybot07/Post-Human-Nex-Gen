const playlistData = [
    { title: '(OST) Dreamseeker', duration: '0:19', number: 1, filename: '1.dreamseeker.mp3' },
    { title: 'YOUtopia', duration: '4:02', number: 2, filename: '2.YOUtopia.mp3' },
    { title: 'Kool-Aid', duration: '3:48', number: 3, filename: '3.Kool-Aid.mp3' },
    { title: 'Top 10 staTues tHat CriEd bloOd', duration: '4:00', number: 4, filename: '4.Top-10-staTues-tHat-CriEd-bloOd.mp3' },
    { title: 'Limousine (featuring Aurora)', duration: '4:11', number: 5, filename: '5.liMOusIne.mp3' },
    { title: 'DArkSide', duration: '2:45', number: 6, filename: '6.DArkSide.mp3' },
    { title: 'A Bullet w/ My Name On (featuring Underoath)', duration: '4:20', number: 7, filename: '7.my_namE_On.mp3' },
    { title: '(OST) (Spi)ritual', duration: '1:54', number: 8, filename: '8.(spi)ritual.mp3' },
    { title: 'N/A', duration: '3:20', number: 9, filename: '9.NA.mp3' },
    { title: 'LosT', duration: '3:25', number: 10, filename: '10.LosT.mp3' },
    { title: 'Strangers', duration: '3:15', number: 11, filename: '11.sTraNgeRs.mp3' },
    { title: 'R.I.P. (Duskcore Remix)', duration: '3:23', number: 12, filename: '12.R.i.p.mp3' },
    { title: 'Amen! (featuring Lil Uzi Vert and Daryl Palumbo)', duration: '3:09', number: 13, filename: '13.AmEN!.mp3' },
    { title: '(OST) P.U.S.S.-E', duration: '2:49', number: 14, filename: '14.p.u.s.s.-e.mp3' },
    { title: 'Die4U', duration: '3:27', number: 15, filename: '15.DiE4u.mp3' },
    { title: 'Dig It', duration: '7:12', number: 16, filename: '16.DIg It.mp3' }
];
